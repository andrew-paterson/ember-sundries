  ...
  */
  {
    ...
    "moduleName": "/home/paddy/development/ember-addons/ember-sundries/@ember/test-helpers/setup-rendering-context.js",
    "isStrictMode": false
  });
...
define("ember-cli-clipboard/test-support/index", ["exports", "ember", "@ember/test-helpers", "@ember/runloop", "@ember/object/internals"], function (_exports, _ember, _testHelpers, _runloop, _internals) {
  "use strict";
  ...
  0; //eaimeta@70e063a35619d71f0,"ember",0,"@ember/test-helpers",0,"@ember/runloop",0,"@ember/object/internals"eaimeta@70e063a35619d71f
  /**
  ...
  function _getComponentBySelector(owner, selector = '.copy-btn') {
    const renderTree = _ember.default._captureRenderTree(owner);
  ...
  function _findComponentInstance(node, guid) {
    if ((0, _internals.guidFor)(node.instance) === guid) {
...
define("ember-responsive/test-support/index", ["exports", "@ember/test-helpers", "@ember/runloop"], function (_exports, _testHelpers, _runloop) {
  "use strict";
